...
![Systemd]({{site.baseurl}}/assets/img/systed.png)
...
![Foreground]({{site.baseurl}}/assets/img/foreground.png)
...
![Foreground]({{site.baseurl}}/assets/img/foreground02.png)
...
ps aux
```
![Foreground]({{site.baseurl}}/assets/img/foreground03.png)
...
![Cron Job]({{site.baseurl}}/assets/img/cron.png)


A crontab is simply a special file with formatting that is recognised by the cron process to execute each line step-by-step. Crontabs require 6 specific values:

![Cron Job]({{site.baseurl}}/assets/img/cron01.png)
...
![Cron Tab 01]({{site.baseurl}}/assets/img/crontab01.png)

![Cron Tab 02]({{site.baseurl}}/assets/img/crontab02.png)
...
/etc/apt$ ls
```
![apt]({{site.baseurl}}/assets/img/apt.png)
...
![apt]({{site.baseurl}}/assets/img/apt02.png)

2.2. And now use ```Nano or a text editor``` of your choice to ```add & save the Sublime Text 3 repository``` into this newly created file:

![apt]({{site.baseurl}}/assets/img/apt03.png)
...
![log]({{site.baseurl}}/assets/img/log.png)
...
![log]({{site.baseurl}}/assets/img/log02.png)
