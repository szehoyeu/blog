...
![TCP Header](https://szehoyeu.github.io/blog/assets/img/tcp-header-rfc793.png)

```
nmap -sN TARGET
```

![NUll Scan TCP Open](https://szehoyeu.github.io/blog/assets/img/null-scan-open.png)

However, we expect the target server to respond with an RST packet if the port is closed. ```Consequently, we can use the lack of RST response to figure out the ports that are not closed: open or filtered```.

![NUll Scan TCP Closed](https://szehoyeu.github.io/blog/assets/img/null-scan-close.png)
...
![FIN Scan TCP Open](https://szehoyeu.github.io/blog/assets/img/fin-scan-open.png)

However, the target system should respond with an RST if the port is closed. Consequently, we will be able to know which ports are closed and use this knowledge to infer the ports that are open or filtered. It's worth noting some firewalls will 'silently' drop the traffic without sending an RST.

![FIN Scan TCP Closed](https://szehoyeu.github.io/blog/assets/img/fin-scan-close.png)
...
nmap -sX TARGET
```
![Xmas Scan TCP](https://szehoyeu.github.io/blog/assets/img/xmas-scan-openclose.png)
...
![CP Maimon Scan](https://szehoyeu.github.io/blog/assets/img/cp-maimon-scan.png)
...
![TCP ACK Scan](https://szehoyeu.github.io/blog/assets/img/tcp-ack-scan.png)
...
![Window Scan](https://szehoyeu.github.io/blog/assets/img/windows-scan.png)
...
![Custom Scan](https://szehoyeu.github.io/blog/assets/img/custom-scan.png)
...
![Spoofing](https://szehoyeu.github.io/blog/assets/img/spoofing.png)
...
![Decoy](https://szehoyeu.github.io/blog/assets/img/decoy.png)
...
![IP Header (RFC 791)](https://szehoyeu.github.io/blog/assets/img/ip-header-rfc791.png)
...
![Wireshark](https://szehoyeu.github.io/blog/assets/img/ws-ss.png)
...
![Wireshark](https://szehoyeu.github.io/blog/assets/img/ws-ff.png)
...
![Idle scan](https://szehoyeu.github.io/blog/assets/img/idle-scan.png)
...
![Idle scan 02](https://szehoyeu.github.io/blog/assets/img/idle-scan02.png)
...
![Idle scan 03](https://szehoyeu.github.io/blog/assets/img/idle-scan03.png)
...
![Summary](https://szehoyeu.github.io/blog/assets/img/summary-port-scan.png)
